"""Chronolog es un módulo diseñado para facilitar la creación de registros (logs).
...
Para saber más sobre el módulo, visite: [chronolog](https://tutosrivegamerlq.github.io/chronolog/)
